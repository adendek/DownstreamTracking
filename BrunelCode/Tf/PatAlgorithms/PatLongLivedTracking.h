...
private:
  ...
  double evaluateSeedClassifier(const LHCb::Track *track);///< Evaluate the Fisher discriminant for a preselection of seed tracks
  ...
  std::map<std::string, double> getTrackParameters(const PatDownTrack& track);
  ...
  std::map<std::string, double > extractTrackParameters(const PatDownTrack& track) const;

  // neural network member methods
  double getMPLValue(const PatDownTrack& track, LHCb::Track* trackSeed);
  ...
  IPatMvaClassifier*                  m_seedSelectionMVATool;
  IPatMvaClassifier*                  m_finalSelectionMVATool;
  ...
  double        m_overlapTol;
  double        m_yTol;
  std::string   m_mvaPreselectionToolName;
  double        m_seedCut;
  std::string   m_mvaFinalSelectionToolName;
  double        m_trackCut;
